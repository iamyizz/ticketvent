<meta charset="utf-8">
<title>Admin Ticket Event</title>
<link rel="icon" href="{{ asset('image/iconticket.png') }}" type="image/x-icon">
...
<link rel="stylesheet" type="text/css" href="{{ asset('darkpan-1.0.0/css/flatpicker.css') }}">
